...
function showQuestion() {
    if (gameIsOver()) {  // ist 10 größer oder gleich 10 dann beende das quiz, ansonsten geh zur nächsten Frage
        endscreen();
    } else {
        updateProgressBar();
        showCard();
...
function gameIsOver() {
    return currentQuestion >= questions.length;  // ist 10 größer oder gleich 10 dann beende das quiz, ansonsten geh zur nächsten Frage
}
